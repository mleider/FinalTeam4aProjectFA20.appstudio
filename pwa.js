...
const cacheName = 'FinalTeam4aProjectFA20-2020-11-20 13:23:00.840100'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'FinalTeam4aProjectFA20'.length) === 'FinalTeam4aProjectFA20') {
